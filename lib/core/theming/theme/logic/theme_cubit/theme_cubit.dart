import 'package:doctor_app/core/helpers/cache_helper/cache_helper.dart';
import 'package:doctor_app/core/theming/theme/components/constant.dart';
import 'package:doctor_app/core/theming/theme/logic/theme_states/theme_state.dart';
...
class ThemeCubit extends Cubit<ThemeState> {
  ...
  ThemeData applicationLightThemeData = ThemeData(
      ...
      switchTheme: SwitchThemeData(
          thumbColor:
              WidgetStatePropertyAll<Color>(ThemeFactory.currentTheme.primary)),
